...
public class Turtle {
	 ...
	 */
	public final void setProperties(final String state, final int angle, final int lineLength, final int startPosition,
		...
		if (startPosition == 1) // Center
			...
			// Bottom
			this.currentState = new TurtleState(canvasWidth / 2, canvasHeight + canvas.getInsets().bottom - OFFSET,
					startAngle);
